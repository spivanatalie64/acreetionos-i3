# AcreetionOS I3 Edition

The classic tiling window manager. Keyboard-driven, scriptable, insanely efficient.
...
```bash
git clone https://github.com/spivanatalie64/acreetionos-i3.git
cd acreetionos-i3
./build.sh
```
...
- **Issues:** https://github.com/spivanatalie64/acreetionos-i3/issues
