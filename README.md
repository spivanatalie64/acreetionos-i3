...
|-------------|-------------|
| `i3` | Human-readable edition name (e.g., "XFCE") |
| `i3` | Short label for ISO volume (e.g., "XFCE") |
| `i3 Tiling WM Community Edition` | Short description |
| `i3` | GitHub repo name suffix |
